...
class VerifyScreen extends StatefulWidget {
  static const String screenRoute = 'verify_screen';
  const VerifyScreen({super.key});

  @override
  State<VerifyScreen> createState() => _VerfiyScreenState();
}

class _VerfiyScreenState extends State<VerifyScreen> {
  @override
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                      ...
                      onPressed: () {
                        Navigator.pushNamed(
                            context, VerifySucessfully.screenRoute);
                      },
                      child: Text(
                        'Submit',
